...
function loop(ts) {
  ...
  render();
  updateHud();
  // Stop scheduling further frames once the match ends -- render()/updateHud()
  // above still ran once more this frame so the final state is on screen.
  // resetGame() restarts the loop for a rematch.
